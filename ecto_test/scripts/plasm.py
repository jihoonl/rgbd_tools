#!/usr/bin/env python
import ecto
from ecto_test.tutorial import Increment, Add

# Crement tree Cell objects
...
plasm = ecto.Plasm()
# create connections inside that graph: the output named of 'output'
# of cell 'i1' is connected to the input named 'a' of cell 'add'
